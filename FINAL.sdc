...
# Set False Path
#**************************************************************
set_false_path -from [get_ports {altera_reserved_tdi altera_reserved_tms KEY* SW* ARDUINO*}] -to *
set_false_path -from * -to [get_ports {altera_reserved_tdo LEDR* ARDUINO* HEX* VGA*}]
