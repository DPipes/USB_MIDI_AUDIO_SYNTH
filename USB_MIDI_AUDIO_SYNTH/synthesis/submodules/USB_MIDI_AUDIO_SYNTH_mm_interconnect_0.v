...
module USB_MIDI_AUDIO_SYNTH_mm_interconnect_0 (
	...
	wire  [104:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_agent:rp_data
	...
	wire  [104:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_agent:rp_data
	...
	wire  [105:0] i2c_0_csr_agent_rf_source_data;                                              // i2c_0_csr_agent:rf_source_data -> i2c_0_csr_agent_rsp_fifo:in_data
	...
	wire  [105:0] i2c_0_csr_agent_rsp_fifo_out_data;                                           // i2c_0_csr_agent_rsp_fifo:out_data -> i2c_0_csr_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> i2c_0_csr_agent:cp_data
	...
	wire  [105:0] nios2_debug_mem_slave_agent_rf_source_data;                                  // nios2_debug_mem_slave_agent:rf_source_data -> nios2_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] nios2_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_debug_mem_slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> nios2_debug_mem_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // nios2_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [15:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire  [105:0] leds_pio_s1_agent_rf_source_data;                                            // leds_pio_s1_agent:rf_source_data -> leds_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] leds_pio_s1_agent_rsp_fifo_out_data;                                         // leds_pio_s1_agent_rsp_fifo:out_data -> leds_pio_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> leds_pio_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                       // leds_pio_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [15:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> leds_pio_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_008_src_data;                                                        // cmd_mux_008:src_data -> key_s1_agent:cp_data
	...
	wire  [105:0] hex_digits_pio_s1_agent_rf_source_data;                                      // hex_digits_pio_s1_agent:rf_source_data -> hex_digits_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] hex_digits_pio_s1_agent_rsp_fifo_out_data;                                   // hex_digits_pio_s1_agent_rsp_fifo:out_data -> hex_digits_pio_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_009_src_data;                                                        // cmd_mux_009:src_data -> hex_digits_pio_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_010_src_data;                                                        // cmd_mux_010:src_data -> keycode_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_011_src_data;                                                        // cmd_mux_011:src_data -> usb_irq_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                       // usb_irq_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [15:0] cmd_mux_011_src_channel;                                                     // cmd_mux_011:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_012_src_data;                                                        // cmd_mux_012:src_data -> usb_gpx_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_013_src_data;                                                        // cmd_mux_013:src_data -> usb_rst_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_015_src_data;                                                        // cmd_mux_015:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [104:0] nios2_data_master_agent_cp_data;                                             // nios2_data_master_agent:cp_data -> router:sink_data
	...
	wire  [104:0] nios2_instruction_master_agent_cp_data;                                      // nios2_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [104:0] i2c_0_csr_agent_rp_data;                                                     // i2c_0_csr_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] leds_pio_s1_agent_rp_data;                                                   // leds_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] key_s1_agent_rp_data;                                                        // key_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [104:0] hex_digits_pio_s1_agent_rp_data;                                             // hex_digits_pio_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [104:0] keycode_s1_agent_rp_data;                                                    // keycode_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [104:0] usb_irq_s1_agent_rp_data;                                                    // usb_irq_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [104:0] usb_gpx_s1_agent_rp_data;                                                    // usb_gpx_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [104:0] usb_rst_s1_agent_rp_data;                                                    // usb_rst_s1_agent:rp_data -> router_015:sink_data
	...
	wire  [104:0] spi_0_spi_control_port_agent_rp_data;                                        // spi_0_spi_control_port_agent:rp_data -> router_017:sink_data
	...
	wire  [104:0] cmd_demux_001_src5_data;                                                     // cmd_demux_001:src5_data -> cmd_mux_005:sink1_data
	...
	wire  [104:0] cmd_demux_001_src8_data;                                                     // cmd_demux_001:src8_data -> cmd_mux_008:sink1_data
	...
	wire  [104:0] cmd_demux_001_src9_data;                                                     // cmd_demux_001:src9_data -> cmd_mux_009:sink1_data
	...
	wire  [104:0] cmd_demux_001_src10_data;                                                    // cmd_demux_001:src10_data -> cmd_mux_010:sink1_data
	...
	wire  [104:0] cmd_demux_001_src11_data;                                                    // cmd_demux_001:src11_data -> cmd_mux_011:sink1_data
	...
	wire  [104:0] cmd_demux_001_src12_data;                                                    // cmd_demux_001:src12_data -> cmd_mux_012:sink1_data
	...
	wire  [104:0] cmd_demux_001_src13_data;                                                    // cmd_demux_001:src13_data -> cmd_mux_013:sink1_data
	...
	wire  [104:0] cmd_demux_001_src14_data;                                                    // cmd_demux_001:src14_data -> cmd_mux_014:sink1_data
	...
	wire  [104:0] cmd_demux_001_src15_data;                                                    // cmd_demux_001:src15_data -> cmd_mux_015:sink1_data
	...
	wire  [104:0] rsp_demux_005_src1_data;                                                     // rsp_demux_005:src1_data -> rsp_mux_001:sink5_data
	...
	wire  [104:0] rsp_demux_008_src1_data;                                                     // rsp_demux_008:src1_data -> rsp_mux_001:sink8_data
	...
	wire  [104:0] rsp_demux_009_src1_data;                                                     // rsp_demux_009:src1_data -> rsp_mux_001:sink9_data
	...
	wire  [104:0] rsp_demux_010_src1_data;                                                     // rsp_demux_010:src1_data -> rsp_mux_001:sink10_data
	...
	wire  [104:0] rsp_demux_011_src1_data;                                                     // rsp_demux_011:src1_data -> rsp_mux_001:sink11_data
	...
	wire  [104:0] rsp_demux_012_src1_data;                                                     // rsp_demux_012:src1_data -> rsp_mux_001:sink12_data
	...
	wire  [104:0] rsp_demux_013_src1_data;                                                     // rsp_demux_013:src1_data -> rsp_mux_001:sink13_data
	...
	wire  [104:0] rsp_demux_014_src1_data;                                                     // rsp_demux_014:src1_data -> rsp_mux_001:sink14_data
	...
	wire  [104:0] rsp_demux_015_src1_data;                                                     // rsp_demux_015:src1_data -> rsp_mux_001:sink15_data
	...
	wire   [15:0] crosser_001_out_channel;                                                     // crosser_001:out_channel -> cmd_mux_004:sink1_channel
	...
	wire   [15:0] rsp_demux_004_src0_channel;                                                  // rsp_demux_004:src0_channel -> crosser_002:in_channel
	...
	wire   [15:0] crosser_002_out_channel;                                                     // crosser_002:out_channel -> rsp_mux:sink4_channel
	...
	wire   [15:0] rsp_demux_004_src1_channel;                                                  // rsp_demux_004:src1_channel -> crosser_003:in_channel
	...
	wire          sdram_pll_pll_slave_agent_rdata_fifo_out_valid;                              // sdram_pll_pll_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] sdram_pll_pll_slave_agent_rdata_fifo_out_data;                               // sdram_pll_pll_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          sdram_pll_pll_slave_agent_rdata_fifo_out_ready;                              // avalon_st_adapter_004:in_0_ready -> sdram_pll_pll_slave_agent_rdata_fifo:out_ready
	...
	USB_MIDI_AUDIO_SYNTH_mm_interconnect_0_router_008 router_008 (
	...
	USB_MIDI_AUDIO_SYNTH_mm_interconnect_0_router_002 router_009 (
	...
	USB_MIDI_AUDIO_SYNTH_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                               //       clk.clk
		.reset              (sdram_pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	USB_MIDI_AUDIO_SYNTH_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	USB_MIDI_AUDIO_SYNTH_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
