...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../USB_MIDI_AUDIO_SYNTH.sopcinfo
...
# Design Name 
# setting SOPC_NAME is USB_MIDI_AUDIO_SYNTH
SOPC_NAME := USB_MIDI_AUDIO_SYNTH
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001270
SOPC_SYSID_FLAG += --sidp=0x4001270
ELF_PATCH_FLAG  += --sidp 0x4001270

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1652309611
SOPC_SYSID_FLAG += --timestamp=1652309611
ELF_PATCH_FLAG  += --timestamp 1652309611
