...
#define DAP_AUDIO_TREBLE_BAND4	0x011E
...
#define DAP_SELECT_ADC	0x0000	//	Set DAP data source to ADC
#define DAP_SELECT_I2S_IN 0x0040 // Set DAP data source to I2S_IN
#define DAC_SELECT_ADC	0x0000	//	Set DAC data source to ADC
#define DAC_SELECT_I2S_IN 0x0010 //L Set DAC data source to I2S_IN
#define DAC_SELECT_DAP	0x0030	//	Set DAC data source to DAP
...
#define HP_VOL_INIT		0x30	//S	Initial volume setting, quite low
...
// DAP_CONTROL
#define MIX_EN			0x0010	//	Enable the DAP mixer path
#define DAP_EN			0x0001	//	Enable DAP

// DAP_PEQ

// DAP_BASS_ENHANCE
#define BYPASS_HPF		0x0100	//	Bypass the high pass filter
#define EN				0x0001	//	Enable bass enhance
