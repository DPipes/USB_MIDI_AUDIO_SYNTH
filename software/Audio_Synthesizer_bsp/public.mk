...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Audio_Synthesizer_SoC.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Audio_Synthesizer_SoC
SOPC_NAME := Audio_Synthesizer_SoC
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x19f0
SOPC_SYSID_FLAG += --sidp=0x19f0
ELF_PATCH_FLAG  += --sidp 0x19f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1653404162
SOPC_SYSID_FLAG += --timestamp=1653404162
ELF_PATCH_FLAG  += --timestamp 1653404162
